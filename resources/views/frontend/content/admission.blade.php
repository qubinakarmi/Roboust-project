...
@section('content')
        ...
        <div class="container">
            <div class="row mb-5">
                ...
                <div class="col-lg-6 mb-lg-0 mb-4">
                    <img src="{{ asset('sections/'.$item->image) }}" alt="Image" class="img-fluid">
                </div>
    ...
    <form action="{{ route('enroll.store') }}" method="POST" data-parsley-validate novalidate>
        @csrf
                        ...
                        <select name="course" class="form-control form-control-lg" required>
                            ...
                            @foreach ($courses as $course)
                                <option value="{{ $course->id }}"
                                    {{ isset($admissions) && $course->id == $admissions->id ? 'selected' : '' }}>
                                    {{ $course->title }}
                                </option>
                            @endforeach
                        </select>
