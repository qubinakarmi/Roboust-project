                ...
                <div class="col-lg-3 text-right">
                    ...
                    @auth
                        <form action="{{ route('logout') }}" method="POST" class="d-inline">
                            @csrf
                            <button type="submit" class="small btn btn-danger px-4 py-2 rounded-0">
            ...
            <div class="d-flex align-items-center">
                <div class="site-logo">
                    <a href="index.html" class="d-block">
                        <img src="{{ asset('settings/'.$settings['logo']) }}" alt="Image" class="img-fluid" style="height: 8.125rem; width:7.5rem;">
                    </a>
                </div>
                <div class="mr-auto">
