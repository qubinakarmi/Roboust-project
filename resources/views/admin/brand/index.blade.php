        ...
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <h3 class="card-title mb-0">Brand Posts</h3>

                    <div class="d-flex justify-content-center align-items-center">
                        <a href="{{ route('brand.create') }}" class="btn btn-success btn-sm p-2" id="btn">
                            ...
                            <tbody>
                                @foreach ($brands as $brand)
                                    <tr>
                                        ...
                                        <td><img src="{{ asset('brands/' . $brand->image) }}" alt="{{ $brand->title }}"
                ...
                <div class="card-footer clearfix">
                    <div class="d-flex justify-content-center">
                        <span class="pagination px-2">{{ $brands->links('pagination::bootstrap-5') }}</span>
                    </div>
                </div>
