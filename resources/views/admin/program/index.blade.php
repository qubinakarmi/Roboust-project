        ...
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <h3 class="card-title mb-0">program Posts</h3>

                    <div class="d-flex justify-content-center align-items-center">
                        <a href="{{ route('program.create') }}" class="btn btn-success btn-sm p-2" id="btn">
                            ...
                            <tbody>
                                @foreach ($programs as $program)
                                    <tr>
                                        ...
                                        {{-- <td><img src="{{ asset('programs/' . $program->image) }}" alt=""
...
--}}
                ...
                <div class="card-footer clearfix">
                    <div class="d-flex justify-content-center">
                        <span class="pagination px-2">{{ $programs->links('pagination::bootstrap-5') }}</span>
                    </div>
                </div>
