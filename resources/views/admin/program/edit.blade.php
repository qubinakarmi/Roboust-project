                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="short_desc" rows="6" class="form-control" placeholder="Write blog short content here..."
                                        ...
                                        >{{ old('short_desc', $program->short_desc) }}</textarea>
                                    @error('short_desc')
                                        <span style="color: red;">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="col-md-12">
                                    ...
                                    <img src="{{ asset('programs/'.$program->image) }}" alt=""
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select name="status" class="form-select">
                                        <option value="1" {{ old('status', $program->status) == 1 ? 'selected' : '' }}>
                                            Published
                                        </option>
                                        <option value="0" {{ old('status', $program->status) == 0 ? 'selected' : '' }}>
                                            Pending
                                        </option>
                                    </select>
