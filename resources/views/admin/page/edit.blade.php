                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="detail_content" class="form-control editor" placeholder="Enter a Detail Content">{{ old('detail_content', $page->detail_content) }}</textarea>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="meta_title" class="form-control"
                                        ...
                                        value="{{ old('meta_title', $page->meta_title) }}"  data-parsley-trigger=" keyup"data-parsley-maxlength="155">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="meta_description" class="form-control" id="editor"  data-parsley-trigger=" keyup"data-parsley-maxlength="180">{{ old('meta_description', $page->meta_description) }}</textarea>
