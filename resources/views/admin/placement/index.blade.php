        ...
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <h3 class="card-title mb-0">Placment Posts</h3>

                    <div class="d-flex justify-content-center align-items-center">
                        <a href="{{ route('place.create') }}" class="btn btn-success btn-sm p-2" id="btn">
                        ...
                        <table class="table table-striped table-hover mb-0">
                            ...
                            <tbody>
                                @foreach ($placements as $placement)
                                    <tr>
                                        <td>{{ $placement->title ?? 'N/A' }}</td>
                                        <td><img src="{{ asset('placements/' . $placement->image) }}" alt=""
                                        ...
                                        <td>{{ $placement->created_at->format('m-d-Y') }}</td>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center align-items-center gap-2">
                                                ...
                                                <!-- Edit -->
                                                <a href="{{ route('place.edit', $placement->id) }}"
                                                    class="btn btn-warning btn-sm">
                                                    <i class="fa-regular fa-pen-to-square"></i>
                                                </a>

                                                <!-- Delete -->
                                                <form action="{{ route('place.destroy', $placement->id) }}" method="POST"
                ...
                <div class="card-footer clearfix">
                    <div class="d-flex justify-content-center">
                        <span class="pagination px-2">{{ $placements->links('pagination::bootstrap-5') }}</span>
                    </div>
                </div>
